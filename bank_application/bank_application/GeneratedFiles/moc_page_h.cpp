/****************************************************************************
** Meta object code from reading C++ file 'page_h.h'
**
...
#error "The header file 'page_h.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 5, 10), // "db_connect"
